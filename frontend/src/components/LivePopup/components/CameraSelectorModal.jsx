...
/**
 * Modal for selecting camera source
 * 
 * @param {Object} props - Component props
 * @param {boolean} props.isOpen - Whether modal is open
 * @param {Array} props.videoDevices - Available video devices
 * @param {Function} props.onClose - Handler for modal close
 * @param {Function} props.onSelect - Handler for device selection
 * @returns {JSX.Element|null} CameraSelectorModal component
 */
const CameraSelectorModal = ({ isOpen, videoDevices, onClose, onSelect }) => {
