...
export default function LivePopup({
  ...
  const handleStartSession = () => {
    console.log('🚀 [LivePopup] START SESSION BUTTON CLICKED!');
    try {
      console.log('🔍 [LivePopup] handleStartSession called');
      ...
      // Build session options including all parameters
      const sessionOptions = {
        currentVoice: voices.find(v => v.id === currentVoice)?.name || currentVoice,
        transcriptionEnabled,
        slidingWindowEnabled,
        slidingWindowTokens,
        nativeAudioFeature,
      ...
      console.log('🔍 [LivePopup] Final session options:', sessionOptions);
      
      // Call App's start function
      onStartSession(null, sessionOptions);
    } catch (error) {
      console.error('🚨 [LivePopup] Error in handleStartSession:', error);
      console.error('🚨 [LivePopup] Error stack:', error.stack);
    }
  };
